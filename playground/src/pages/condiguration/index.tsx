...
function Configuration() {
  ...
  const { deviceId, endpointUrl, canChangeEndpoint, setNewDeviceId, setNewEndpoint } = configStore;
    ...
    <div className={s.content}>
      <div className={s.form}>
        ...
        <div className={s.item}>
          ...
          <input type="text" defaultValue={deviceId || undefined} onBlur={ev => setNewDeviceId(ev.target.value)} />
        </div>
      </div>
    </div>
  );
